        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerActions}>
            <View style={styles.headerActionsLeft}>
              ...
              >
                <FontAwesome5 name="pen" size={12} color={COLORS.primary} solid />
              ...
              >
                <FontAwesome5 name="trash" size={12} color={COLORS.danger} solid />
            ...
            >
              <FontAwesome5 name="share-alt" size={16} color={COLORS.accent} solid />
            </TouchableOpacity>
          </View>
        </View>
      )}
